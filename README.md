...
If your impedance spectrum exhibits a low-frequency inductive loop, the most recent software for 
the DRT/DTT calculations using the m-composite kernel can be downloaded here:
